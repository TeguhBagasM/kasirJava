...
public class appCheckOut extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bayar.setPreferredSize(new java.awt.Dimension(46, 16));
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 370, -1, 40));
    ...
    private void bayarMouseClicked(java.awt.event.MouseEvent evt) {                                   
        ...
        if (bayar.isEmpty()) {
            ...
            int pernyataan = JOptionPane.showConfirmDialog(null, "Yakin Bayar?", "Konfirmasi", 
                    JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);

            if (pernyataan == JOptionPane.OK_OPTION) {
                try {
                    double totalHarga = Double.parseDouble(totalBiaya);
                    double uangDiberikan = Double.parseDouble(bayar);
                    double nilaiKembalian = uangDiberikan - totalHarga;

                    if (nilaiKembalian < 0) {
                        JOptionPane.showMessageDialog(this, "Uang yang diberikan kurang!", "Error", JOptionPane.ERROR_MESSAGE);
                    } else {
                        Connection conn = DB.getKoneksi();
                        String sql = "UPDATE auth SET totalPembelian = totalPembelian + ?, tipeUser = 'pelanggan' WHERE username = ?";
                        PreparedStatement pr = conn.prepareStatement(sql);
                        pr.setDouble(1, totalHarga);
                        pr.setString(2, uname);
                        pr.executeUpdate();
                        pr.close();

                        JOptionPane.showMessageDialog(null, "Pembayaran Berhasil\nKembalian: Rp " + String.format("%.2f", nilaiKembalian));

                        appCheckOut direct = new appCheckOut();
    ...
    private void tabelPembelianMouseClicked(java.awt.event.MouseEvent evt) {                                            
    ...
    private void uangPembayaranActionPerformed(java.awt.event.ActionEvent evt) {                                               
        
        try {
        double total = Double.parseDouble(totalBayar.getText());
        double bayar = Double.parseDouble(uangPembayaran.getText());

        if (bayar < total) {
            JOptionPane.showMessageDialog(null, "Uang tidak cukup untuk melakukan pembayaran");
            kembalian.setText("0");
        } else {
            double kembaliann = bayar - total;
            kembalian.setText(String.format("%.2f", kembaliann));
        }
    ...
    private void menuPopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {                                                
    ...
    private void tipemenuPopupMenuWillBecomeVisible(javax.swing.event.PopupMenuEvent evt) {                                                    
        
    }                                                   

    private void tipemenuPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {                                                      
    ...
    private void menuPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {                                                  
